...
Build a small local autonomy envelope for the work I delegate:
...
- changing licensing or other explicit policy boundaries;
- destructive or irreversible changes outside the declared task.

Escalate:
- any genuine identity/ultimate-policy question or decision outside the delegated envelope.

When escalating, return:
1. the policy/identity question;
2. evidence/context;
3. viable options;
4. operational consequence of no decision.

After I decide, record the returned constraint and continue subsequent work under it.

Do not treat ordinary task approval, PR review, or permission prompts as S5. Until the roadmap milestone is actually demonstrated, describe this as a parent-control-plane demo rather than claiming `S5=P` completion.
```